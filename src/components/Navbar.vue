    ...
    <mdb-navbar-toggler>
      <mdb-navbar-nav>
        ...
        <mdb-dropdown tag="li" class="nav-item">
          <mdb-dropdown-toggle v-if="isUserAuth" tag="a" navLink color="success-color-dark" slot="toggle" waves-fixed><mdb-icon icon="user" /> {{ getUser.displayName }} </mdb-dropdown-toggle>
          <mdb-dropdown-menu>
            <mdb-dropdown-item><mdb-icon icon="heart" /> My Favorite</mdb-dropdown-item>
            <mdb-dropdown-item @click="check"><mdb-icon icon="key" /> Change Password</mdb-dropdown-item>
...
<script>
  import { mdbIcon,mdbNavbar, mdbNavbarBrand, mdbNavbarToggler, mdbNavbarNav, mdbNavItem, mdbDropdown, mdbDropdownMenu, mdbDropdownToggle, mdbInput, mdbDropdownItem } from 'mdbvue';
